...
walk_2m_01_plain_odometry_legacy (Information Filter)
...
BAG_DB    = os.path.join(BASE, '..', 'bags',
                         'legacy_odom20260514_222433',
                         'legacy_odom20260514_222433_0.db3')
VICON_CSV = os.path.join(BASE, '..', 'vicon', 'EXP_03.csv')
TRIAL     = 'walk_2m_01_plain_odometry_legacy'
DATE      = '20260514'
EXP_ID    = 'exp3'
...
# -- XZ trajectory plot
fig, ax = plt.subplots(figsize=(7, 5))
vi_pz_traj = interp_to(vi_t_v, pos_vicon[vi_valid, 2], pt)
