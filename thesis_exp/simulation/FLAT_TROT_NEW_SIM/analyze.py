...
BAG = Path("/home/hiho817/analysis_ws/thesis_exp/simulation/FLAT_TROT_NEW_SIM/FLAT_TROT_NEW_SIM_0.db3")
...
def main():
    ...
    end = min(7.0, ekf["t"].max(), gt_pos["t"].max(), gt_tf["t"].max())
