...
# REAL_2 calibration against 20-mm VICON truth (macro balanced accuracy = 79.6%).
...
def replay_gmo_contact(gmo_raw):
    """Replay the OR-Schmitt trigger calibrated for this trial."""
    result = {'t': gmo_raw['t']}
...
def write_comparison_plots(all_metrics):
    ...
    plt.close(fig)
    print('[Summary] → fig_comparison.pdf')
