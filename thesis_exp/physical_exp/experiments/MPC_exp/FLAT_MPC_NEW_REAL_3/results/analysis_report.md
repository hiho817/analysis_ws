...
| MPC (模型預測控制) | ESEKF | 1 | 1.222 ± 0.000 | 5.074 ± 0.000 | 0.930 ± 0.000 | 5.302 ± 0.000 | 0.028 ± 0.000 | 0.049 ± 0.000 | 0.015 ± 0.000 | 0.058 ± 0.000 |
...
|----------|-------------|--------------|----|----|----|----|
| FLAT_MPC_NEW_REAL_3 | 91.8% | 56338 | 38964 | 12723 | 210 | 4441 |
...
|------|--------------|-------------------|--------------------------|--------------------------|
| ESEKF (NEW) | 3.017 ± 0.000 m | 2.983 ± 0.000 m | 1.7 cm | 1.7 cm |
| Legacy (OLD) | N/A m | N/A m | N/A | N/A cm |

**分析：**
- ESEKF（NEW）：估測器回報 3.017 ± 0.000 m，VICON 實際停止 2.983 ± 0.000 m，平均停止誤差 **1.7 cm**（< 2 cm）。估測結果與實際高度吻合，控制器能精準停止於目標位置。
