...
| MPC (模型預測控制) | Legacy | 1 | 14.525 ± 0.000 | 3.039 ± 0.000 | 2.392 ± 0.000 | 15.031 ± 0.000 | 0.029 ± 0.000 | 0.036 ± 0.000 | 0.048 ± 0.000 | 0.067 ± 0.000 |
...
| Legacy (OLD) | 3.008 ± 0.000 m | 2.761 ± 0.000 m | 0.8 cm | 23.9 cm |

**分析：**
- ESEKF（NEW）：估測器回報 N/A m，VICON 實際停止 N/A m，平均停止誤差 **N/A cm**（< 2 cm）。估測結果與實際高度吻合，控制器能精準停止於目標位置。
- Legacy（OLD）：估測器回報 3.008 ± 0.000 m，VICON 實際停止 2.761 ± 0.000 m，平均停止誤差 **23.9 cm**（~24 cm，超出目標 24 cm）。Legacy 里程計嚴重**高估**行進距離（腿式積分累積誤差），導致機器人尚未到達 3 m 目標便誤判已抵達而停止。
...
- **Legacy**：VICON 實際停止 2.761 ± 0.000 m，誤差 **23.9 cm** ✗（估測器虛報抵達，實際距離不足）
