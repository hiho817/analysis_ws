...
| MPC (模型預測控制) | ESEKF | 1 | 1.194 ± 0.000 | 6.977 ± 0.000 | 4.527 ± 0.000 | 8.402 ± 0.000 | 0.026 ± 0.000 | 0.038 ± 0.000 | 0.019 ± 0.000 | 0.050 ± 0.000 |
...
|----------|-------------|--------------|----|----|----|----|
| FLAT_MPC_NEW_REAL_4 | 88.8% | 56127 | 38857 | 10965 | 166 | 6139 |
...
|------|--------------|-------------------|--------------------------|--------------------------|
| ESEKF (NEW) | 3.018 ± 0.000 m | 2.998 ± 0.000 m | 1.8 cm | 0.2 cm |
| Legacy (OLD) | N/A m | N/A m | N/A | N/A cm |

**分析：**
- ESEKF（NEW）：估測器回報 3.018 ± 0.000 m，VICON 實際停止 2.998 ± 0.000 m，平均停止誤差 **0.2 cm**（< 2 cm）。估測結果與實際高度吻合，控制器能精準停止於目標位置。
...
- **ESEKF**：VICON 實際停止 2.998 ± 0.000 m，誤差 **0.2 cm** ✓
