...
|----------|------|--------------|--------|--------|--------|---------|--------|--------|--------|---------|
| FLAT_WLW_NEW_REAL_5 | NEW_WLW | 0.0–36.9 | 4.61 | 1.92 | 1.47 | 5.21 | 0.018 | 0.023 | 0.014 | 0.033 |
...
| WLW (輪足步行) | ESEKF | 1 | 4.612 ± 0.000 | 1.921 ± 0.000 | 1.466 ± 0.000 | 5.207 ± 0.000 | 0.018 ± 0.000 | 0.023 ± 0.000 | 0.014 ± 0.000 | 0.033 ± 0.000 |
...
| 實驗編號 | Roll (°) | Pitch (°) | Yaw (°) |
|----------|----------|-----------|---------|
| FLAT_WLW_NEW_REAL_5 | 0.167 | 0.204 | 0.453 |
...
|----------|-------------|-------------|--------------|
| FLAT_WLW_NEW_REAL_5 | 0.95 | 0.58 | 1.12 |
...
|----------|-------------|--------------|----|----|----|----|
| FLAT_WLW_NEW_REAL_5 | 59.8% | 49627 | 24077 | 5697 | 13964 | 5889 |
