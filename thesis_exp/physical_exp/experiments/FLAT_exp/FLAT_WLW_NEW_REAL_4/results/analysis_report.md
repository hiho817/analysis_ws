...
|----------|------|--------------|--------|--------|--------|---------|--------|--------|--------|---------|
| FLAT_WLW_NEW_REAL_4 | NEW_WLW | 0.0–34.7 | 4.21 | 2.67 | 2.37 | 5.52 | 0.018 | 0.024 | 0.011 | 0.032 |
...
| WLW (輪足步行) | ESEKF | 1 | 4.215 ± 0.000 | 2.669 ± 0.000 | 2.372 ± 0.000 | 5.524 ± 0.000 | 0.018 ± 0.000 | 0.024 ± 0.000 | 0.011 ± 0.000 | 0.032 ± 0.000 |
...
| 實驗編號 | Roll (°) | Pitch (°) | Yaw (°) |
|----------|----------|-----------|---------|
| FLAT_WLW_NEW_REAL_4 | 0.351 | 0.533 | 0.450 |
...
|----------|-------------|-------------|--------------|
| FLAT_WLW_NEW_REAL_4 | 1.12 | 1.19 | 1.63 |
...
|----------|-------------|--------------|----|----|----|----|
| FLAT_WLW_NEW_REAL_4 | 60.6% | 49642 | 24549 | 5626 | 13459 | 6008 |
