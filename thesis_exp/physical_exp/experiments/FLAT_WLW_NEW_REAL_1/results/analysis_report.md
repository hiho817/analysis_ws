...
|----------|------|--------------|--------|--------|--------|---------|--------|--------|--------|---------|
| FLAT_WLW_NEW_REAL_1 | NEW_WLW | 0.0–34.7 | 6.23 | 1.22 | 0.55 | 6.38 | 0.019 | 0.024 | 0.012 | 0.033 |
...
| WLW (輪足步行) | ESEKF | 1 | 6.235 ± 0.000 | 1.220 ± 0.000 | 0.547 ± 0.000 | 6.377 ± 0.000 | 0.019 ± 0.000 | 0.024 ± 0.000 | 0.012 ± 0.000 | 0.033 ± 0.000 |
...
| 實驗編號 | Roll (°) | Pitch (°) | Yaw (°) |
|----------|----------|-----------|---------|
| FLAT_WLW_NEW_REAL_1 | 0.194 | 0.234 | 0.177 |
