...
| MPC (模型預測控制) | Legacy | 1 | 15.285 ± 0.000 | 4.243 ± 0.000 | 1.831 ± 0.000 | 15.969 ± 0.000 | 0.031 ± 0.000 | 0.041 ± 0.000 | 0.044 ± 0.000 | 0.068 ± 0.000 |
...
| Legacy (OLD) | 3.002 ± 0.000 m | 2.736 ± 0.000 m | 0.2 cm | 26.4 cm |

**分析：**
- ESEKF（NEW）：估測器回報 N/A m，VICON 實際停止 N/A m，平均停止誤差 **N/A cm**（< 2 cm）。估測結果與實際高度吻合，控制器能精準停止於目標位置。
- Legacy（OLD）：估測器回報 3.002 ± 0.000 m，VICON 實際停止 2.736 ± 0.000 m，平均停止誤差 **26.4 cm**（~24 cm，超出目標 24 cm）。Legacy 里程計嚴重**高估**行進距離（腿式積分累積誤差），導致機器人尚未到達 3 m 目標便誤判已抵達而停止。
...
- **Legacy**：VICON 實際停止 2.736 ± 0.000 m，誤差 **26.4 cm** ✗（估測器虛報抵達，實際距離不足）
