...
|----------|------|--------------|--------|--------|--------|---------|--------|--------|--------|---------|
| FLAT_Walk_NEW_REAL_3 | NEW_WALK | 0.0–38.4 | 1.35 | 5.63 | 1.23 | 5.92 | 0.045 | 0.053 | 0.021 | 0.073 |
...
|------|------|---|------------|------------|------------|-------------|-------------|-------------|-------------|--------------|
| Walk (步行) | ESEKF | 1 | 1.351 ± 0.000 | 5.627 ± 0.000 | 1.226 ± 0.000 | 5.916 ± 0.000 | 0.045 ± 0.000 | 0.053 ± 0.000 | 0.021 ± 0.000 | 0.073 ± 0.000 |
...
| 實驗編號 | Roll (°) | Pitch (°) | Yaw (°) |
|----------|----------|-----------|---------|
| FLAT_Walk_NEW_REAL_3 | 1.174 | 0.354 | 0.963 |
...
|----------|-------------|--------------|----|----|----|----|
| FLAT_Walk_NEW_REAL_3 | 56.7% | 59349 | 33598 | 236 | 10530 | 14985 |
