...
| MPC (模型預測控制) | Legacy | 1 | 17.371 ± 0.000 | 2.604 ± 0.000 | 3.261 ± 0.000 | 17.865 ± 0.000 | 0.024 ± 0.000 | 0.035 ± 0.000 | 0.038 ± 0.000 | 0.057 ± 0.000 |
...
| Legacy (OLD) | 3.003 ± 0.000 m | 2.747 ± 0.000 m | 0.3 cm | 25.3 cm |

**分析：**
- ESEKF（NEW）：估測器回報 N/A m，VICON 實際停止 N/A m，平均停止誤差 **N/A cm**（< 2 cm）。估測結果與實際高度吻合，控制器能精準停止於目標位置。
- Legacy（OLD）：估測器回報 3.003 ± 0.000 m，VICON 實際停止 2.747 ± 0.000 m，平均停止誤差 **25.3 cm**（~24 cm，超出目標 24 cm）。Legacy 里程計嚴重**高估**行進距離（腿式積分累積誤差），導致機器人尚未到達 3 m 目標便誤判已抵達而停止。
