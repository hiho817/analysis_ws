...
| MPC (模型預測控制) | ESEKF | 1 | 0.894 ± 0.000 | 4.824 ± 0.000 | 2.157 ± 0.000 | 5.359 ± 0.000 | 0.026 ± 0.000 | 0.047 ± 0.000 | 0.019 ± 0.000 | 0.057 ± 0.000 |
...
|----------|-------------|--------------|----|----|----|----|
| FLAT_MPC_NEW_REAL_5 | 91.7% | 56562 | 38901 | 12961 | 259 | 4441 |
...
|------|--------------|-------------------|--------------------------|--------------------------|
| ESEKF (NEW) | 2.999 ± 0.000 m | 2.992 ± 0.000 m | 0.1 cm | 0.8 cm |
| Legacy (OLD) | N/A m | N/A m | N/A | N/A cm |

**分析：**
- ESEKF（NEW）：估測器回報 2.999 ± 0.000 m，VICON 實際停止 2.992 ± 0.000 m，平均停止誤差 **0.8 cm**（< 2 cm）。估測結果與實際高度吻合，控制器能精準停止於目標位置。
...
- **ESEKF**：VICON 實際停止 2.992 ± 0.000 m，誤差 **0.8 cm** ✓
