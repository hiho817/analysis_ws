...
|----------|------|--------------|--------|--------|--------|---------|--------|--------|--------|---------|
| FLAT_WLW_NEW_REAL_3 | NEW_WLW | 0.0–37.1 | 5.38 | 1.38 | 0.65 | 5.59 | 0.019 | 0.024 | 0.011 | 0.033 |
...
| WLW (輪足步行) | ESEKF | 1 | 5.380 ± 0.000 | 1.378 ± 0.000 | 0.654 ± 0.000 | 5.592 ± 0.000 | 0.019 ± 0.000 | 0.024 ± 0.000 | 0.011 ± 0.000 | 0.033 ± 0.000 |
...
| 實驗編號 | Roll (°) | Pitch (°) | Yaw (°) |
|----------|----------|-----------|---------|
| FLAT_WLW_NEW_REAL_3 | 0.640 | 0.289 | 0.326 |
...
|----------|-------------|-------------|--------------|
| FLAT_WLW_NEW_REAL_3 | 1.98 | 0.63 | 2.07 |
...
|----------|-------------|--------------|----|----|----|----|
| FLAT_WLW_NEW_REAL_3 | 43.2% | 48200 | 18438 | 2335 | 17579 | 9848 |
