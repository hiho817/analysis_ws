...
|----------|------|--------------|--------|--------|--------|---------|--------|--------|--------|---------|
| FLAT_Walk_NEW_REAL_6 | NEW_WALK | 0.0–33.5 | 1.34 | 5.61 | 3.38 | 6.68 | 0.038 | 0.052 | 0.021 | 0.067 |
...
|------|------|---|------------|------------|------------|-------------|-------------|-------------|-------------|--------------|
| Walk (步行) | ESEKF | 1 | 1.337 ± 0.000 | 5.607 ± 0.000 | 3.378 ± 0.000 | 6.681 ± 0.000 | 0.038 ± 0.000 | 0.052 ± 0.000 | 0.021 ± 0.000 | 0.067 ± 0.000 |
...
| 實驗編號 | Roll (°) | Pitch (°) | Yaw (°) |
|----------|----------|-----------|---------|
| FLAT_Walk_NEW_REAL_6 | 0.786 | 1.054 | 0.510 |
...
|----------|-------------|-------------|--------------|
| FLAT_Walk_NEW_REAL_6 | 1.01 | 3.98 | 4.10 |
...
|----------|-------------|--------------|----|----|----|----|
| FLAT_Walk_NEW_REAL_6 | 85.7% | 50703 | 34880 | 8509 | 1335 | 5979 |
