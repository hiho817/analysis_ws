...
|----------|------|--------------|--------|--------|--------|---------|--------|--------|--------|---------|
| FLAT_Walk_NEW_REAL_4 | NEW_WALK | 0.0–35.0 | 1.52 | 5.95 | 1.38 | 6.29 | 0.040 | 0.054 | 0.023 | 0.071 |
...
|------|------|---|------------|------------|------------|-------------|-------------|-------------|-------------|--------------|
| Walk (步行) | ESEKF | 1 | 1.520 ± 0.000 | 5.950 ± 0.000 | 1.378 ± 0.000 | 6.294 ± 0.000 | 0.040 ± 0.000 | 0.054 ± 0.000 | 0.023 ± 0.000 | 0.071 ± 0.000 |
...
| 實驗編號 | Roll (°) | Pitch (°) | Yaw (°) |
|----------|----------|-----------|---------|
| FLAT_Walk_NEW_REAL_4 | 0.662 | 0.505 | 0.256 |
...
|----------|-------------|-------------|--------------|
| FLAT_Walk_NEW_REAL_4 | 0.60 | 4.80 | 4.84 |
...
|----------|-------------|--------------|----|----|----|----|
| FLAT_Walk_NEW_REAL_4 | 87.2% | 53524 | 37486 | 9157 | 1412 | 5469 |
