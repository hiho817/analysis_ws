...
| MPC (模型預測控制) | ESEKF | 1 | 1.185 ± 0.000 | 5.679 ± 0.000 | 2.077 ± 0.000 | 6.161 ± 0.000 | 0.031 ± 0.000 | 0.047 ± 0.000 | 0.015 ± 0.000 | 0.058 ± 0.000 |
...
|----------|-------------|--------------|----|----|----|----|
| FLAT_MPC_NEW_REAL_1 | 90.4% | 56216 | 38976 | 11837 | 697 | 4706 |
...
|------|--------------|-------------------|--------------------------|--------------------------|
| ESEKF (NEW) | 2.997 ± 0.000 m | 2.985 ± 0.000 m | 0.3 cm | 1.5 cm |
| Legacy (OLD) | N/A m | N/A m | N/A | N/A cm |

**分析：**
- ESEKF（NEW）：估測器回報 2.997 ± 0.000 m，VICON 實際停止 2.985 ± 0.000 m，平均停止誤差 **1.5 cm**（< 2 cm）。估測結果與實際高度吻合，控制器能精準停止於目標位置。
...
- **ESEKF**：VICON 實際停止 2.985 ± 0.000 m，誤差 **1.5 cm** ✓
