...
|----------|------|--------------|--------|--------|--------|---------|--------|--------|--------|---------|
| FLAT_Walk_NEW_REAL_5 | NEW_WALK | 0.0–34.3 | 1.73 | 9.77 | 2.15 | 10.15 | 0.040 | 0.052 | 0.023 | 0.070 |
...
|------|------|---|------------|------------|------------|-------------|-------------|-------------|-------------|--------------|
| Walk (步行) | ESEKF | 1 | 1.728 ± 0.000 | 9.773 ± 0.000 | 2.153 ± 0.000 | 10.155 ± 0.000 | 0.040 ± 0.000 | 0.052 ± 0.000 | 0.023 ± 0.000 | 0.070 ± 0.000 |
...
| 實驗編號 | Roll (°) | Pitch (°) | Yaw (°) |
|----------|----------|-----------|---------|
| FLAT_Walk_NEW_REAL_5 | 0.861 | 0.811 | 0.834 |
...
|----------|-------------|-------------|--------------|
| FLAT_Walk_NEW_REAL_5 | 0.76 | 5.74 | 5.79 |
...
|----------|-------------|--------------|----|----|----|----|
| FLAT_Walk_NEW_REAL_5 | 86.6% | 51714 | 35453 | 9316 | 1674 | 5271 |
